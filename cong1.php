...
?>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
    ...
    <!--<button type="button" class="btn btn-outline-success mr-2 red_btn" data-toggle="modal" data-target="#login_model">logout</button>-->

    <a href="logout.php" class="btn btn-outline-success mr-2 red_btn">logout</a>

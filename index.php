  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content boxmodel_login">
      <form action="login.php" method="post">
        ...
        <div><p?>Not Register Yet <a href="../gharlijiye-main/pages/signup.php">register hear</a></p></div>
      </form>
    </div>
  </div>
</div>
...
<div  class="container_refer" >
  ...
  <!--<input type="text" placeholder="enter refrel code">
...
<button type="button" class="btn btn-outline-success mr-2 red_btn" data-toggle="modal" data-target="#refrel">CLICK HERE FOR REFER AND EARN</button>

<div class="modal fade" id="refrel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content boxmodel_login">
      <form action="" method="post">
        <div class="form-group row mx-auto my-2">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="inputEmail3" name="email" placeholder="Enter Refrel Code">
          </div>
        </div>
        <!--<div class="form-group row mx-auto my-2">
          <label for="inputPassword3" class="col-sm-2 col-form-label ">Password</label>
        ...
        <div class="form-group row mx-auto my-2">
          <div class="col-sm-10">
            <button type="submit" name="login" class="btn btn-secondry ">submit</button>
          </div>
        </div>
